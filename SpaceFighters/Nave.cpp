...
ANave::ANave()
{
	...
	SM_Nave = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("SM_Nave"));
...
void ANave::MoveX(float _AxisValueX)
{

	AddMovementInput(FVector(_AxisValueX, 0.0f, 0.0f), 1.0f, false);
}

void ANave::MoveZ(float _AxisValueZ)
{


	AddMovementInput(FVector(0.0f, 0.0f, _AxisValueZ), 1.0f, false);
}
